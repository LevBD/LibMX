...
int mx_quicksort(char **arr, int left, int right); // не сделана;
...
char *mx_strstr(const char *haystak, const char *needle);
int mx_strncmp(const char *str1, const char *str2, int len_str2); //Моя фукция;
